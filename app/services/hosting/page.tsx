        ...
        <section className="hero-gradient pt-36 pb-16 px-6 text-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm text-white/70">Hosting Services</span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-3">
              Reliable infrastructure built<br />
              <span className="text-brand-300">for compliance and scale.</span>
            </h1>
            <p className="text-blue-100 leading-relaxed max-w-2xl mb-8">
              Enterprise-grade hosting, IaaS, disaster recovery, and hybrid cloud — managed by senior engineers who understand the uptime and compliance requirements your business depends on.
            </p>
